# Compiler and flags
CC = gcc
CFLAGS = -g -I lex -I alt-parse -I alt-compile -I lex/include -I alt-parse/include -I alt-compile/include -I fileh/include
...
SRC = main.c data.c src/get.c src/dir.c src/flush.c \
      ...
      alt-compile/compile.c alt-compile/src/cfh.c alt-compile/src/datatype.c alt-compile/src/findfh.c \
      alt-compile/src/remove.c alt-compile/src/s_block.c alt-compile/src/s_decl.c alt-compile/src/s_for.c \
      alt-compile/src/scanl.c alt-compile/src/serialize.c alt-compile/src/s_print.c alt-compile/src/inc.c \
      fileh/src/create.c fileh/src/file_utils.c fileh/src/insert.c fileh/src/get.c
