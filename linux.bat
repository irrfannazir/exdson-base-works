...
gcc -g main.c data.c src/get.c src/dir.c src/flush.c \
    ...
    alt-compile/src/insertfh.c alt-compile/src/pfh.c alt-compile/src/remove.c alt-compile/src/s_block.c \
    alt-compile/src/s_decl.c alt-compile/src/s_for.c alt-compile/src/scanl.c alt-compile/src/serialize.c \
    alt-compile/src/s_print.c alt-compile/src/linefh.c alt-compile/src/inc.c \
    -I lex -I alt-parse -I alt-compile -I lex/include -I alt-parse/include -I alt-compile/include \
    -o ex-c
./ex-c main.ex
